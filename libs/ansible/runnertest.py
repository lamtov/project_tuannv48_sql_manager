...
inventory_dir = '/root/app' +  '/static/ansible/inventory'
playbook_dir = '/root/app' +  '/static/ansible/playbooks'
facts_dir = '/root/app' +  '/static/ansible/facts'
role_dir = '/root/app' +  '/static/ansible/playbooks/roles'
