...
class Options(object):
    ...
    def __init__(self, verbosity=None, inventory=None, listhosts=False, subset=None, module_paths=None, extra_vars=None,
                 ...
                 syntax=False, diff=False, force_handlers=None, flush_cache=None, listtasks=False, listtags=False, module_path=None):
...
class Runner(object):
    ...
    def __init__(self, hostnames, playbook, private_key_file, run_data, become_pass,inventory, verbosity=0 ):

        self.run_data = run_data

        self.options = Options()
	#self.options.listtags=False
        self.options.tags=['install']
