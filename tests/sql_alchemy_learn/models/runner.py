...
#         self.hosts.close()
        ...
        inventory_dir= '/home/vttek/lamtv10/etc/ansible/inventory'
        ...
        pb_dir = '/home/vttek/lamtv10/etc/ansible/playbooks'
...
if __name__=="__main__":
    #test_add_nodes()
    print("lamtv10")
    runner = Runner('ansible_compute.yml','multnode',{'extra_vars':{'target':"ta1"} ,'tags':['install','uninstall']},None, False,  None,None,None)
    stats = runner.run()
    print_stats(stats)
